...
- The essence of collisional plasmas is the presence of small angle [Coulomb collisions](Rutherford_scattering), which permit the transfer of energy and momentum between plasma particles. In this code I follow the wise suggestions given by Paul Bellan in his 1.7 exercise and built a numerical integrator for the motion of a charge particle in the presence of variable EM fields, then I used it to simulate the scattering of two charged particles given that the scattering problem can be recast into a one particle problem in the relative frame of motion (exercise 1.8).
